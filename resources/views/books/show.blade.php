    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-widget">
                ...
                <div class="box-body">
                    <h1>{{$book->name}}</h1>
                    <h1>{{\App\Category::find($book->category_id)->name}}</h1>
                    ...
                    <div>
                        ...
                        <h3>Available : {{$book->quantity}}</h3>
                    </div>
                    <form method="post" action="/books/{{$book->id}}/order">
                        {{csrf_field()}}
                        <input name="quantity"
                               type="number" class="form-control" placeholder="Enter quantity">
